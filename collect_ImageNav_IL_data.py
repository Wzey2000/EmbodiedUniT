...
parser.add_argument('--data-dir', type=str, default="/data/hongxin_li/Habitat_web/ImageNav", help='directory to save the collected data')
        ...
        for i in range(left_idx, right_idx):
            ...
            if not os.path.exists(save_path):
                ...
                traj_dict = {'position': [], 'rotation': [], 'action': [],
                    'rgb': [], 'depth': [],
                    'target_idx': [0] * MAX_TRAJ_LEN, 'target_img': [], 'target_pose': [], 'target_rot': [],
                    'distance': []}
                ...
                #     vout.write(frame)
                # vout.release()
                traj_dict['target_img'].append(copy.deepcopy(traj_dict['rgb'][-1]))
