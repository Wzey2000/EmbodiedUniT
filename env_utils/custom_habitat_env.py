...
class Env:
    ...
    def __init__(
        ...
        self._task = make_task(
            self._config.TASK.TYPE, # Nav-v0
            config=self._config.TASK, # Nav-v0
            sim=self._sim
        )
    ...
    def reset(self) -> Observations:
        ...
        # self._current_episode is a NavigationEpisode instance (defined in habitat.tasks.nav.nav.NavigationEpisode)
    ...
    def update_measures(self, action):
...
class RLEnv(gym.Env):
    ...
    def update_measures(self, action):
        self._env.update_measures(action)
